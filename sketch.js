...
function draw() {
  ...
  fill("white");
  textSize(15);
  text("Press 'SPACE' to get 2nd chance, Drag the mouse and release to play.",50,50);

  fill("white");
  textSize(15);
  text("If all the blocks are not visible then Game over.",50,70);

  fill("white");
  textSize(15);
  text("To play again reload the page.",50,90);
